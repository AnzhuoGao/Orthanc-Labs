#!/usr/bin/env python3
"""
Raspberry Pi Camera Sensor Data Collection Client for Bird Detection
...
2. Transmit real-time updates to the bird detection visualization server
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/var/log/orthanc_bird_camera_sensor.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger('BirdCameraSensor')
