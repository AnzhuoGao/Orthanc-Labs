...
This script monitors voxel grid data from the bird detection system and 
...
# Voxel Grid data with bird detection info
class VoxelGrid:
    def __init__(self):
        self.grid = None
    ...
    def draw_detections(self, tracker):
        """Draw detected birds with enhanced visualization"""
