#!/bin/bash
"""
Orthanc Labs Real-Time Bird Detection System Launcher
Starts the camera position server and visualizer for real-time bird detection.
"""
...
echo "======================================================="
echo "  ORTHANC LABS - REAL-TIME BIRD DETECTION SYSTEM"
echo "======================================================="
echo "Starting real-time bird detection monitoring..."
echo ""
